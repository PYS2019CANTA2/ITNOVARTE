  ...
  $(function() {
    ...
    $('#contact-form').validate({
        ...
        submitHandler: function(form) 
		{
			...
			$("#output").html('<i class="icon-send fa fa-spinner fa-spin"></i> El correo electrónico está enviando...</p>');	
			$.ajax({	
				type: "POST",
				url: "php/mail.php",
				data: $(form).serialize(),
				...
				success: function(data)
				{
					if(data == "ok")
					{
						...
						$("#output").html('<p>Gracias por contactarnos. Lo antes posible nos pondremos en contacto con usted.</p>');	
					}
					else
					{
						$("#output").css("background-color","#DE654E");
						$("#output").html('<p>Correo electrónico NO enviado!!</p>');	
					}
...
/* Validate Sign */
  $(function() {
    ...
    $('#sign-form').validate({
        ...
        // Specify the validation error messages
        messages: {
            email: "Por favor ingrese un correo váido.",
        },
